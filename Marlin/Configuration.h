...
#define STRING_CONFIG_H_AUTHOR "(Luca, FLSUN Q5)" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 198.8// (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -0.19, 0.0, -1.24 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 106.37             // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.16, 0.40, -0.23 } // Get these values from G33 auto calibrate
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 419.9 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -19.50 } // -18
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define G26_XY_FEEDRATE_TRAVEL 160    // (mm/s) Feedrate for G26 XY travel moves.
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, 0, 80 }
